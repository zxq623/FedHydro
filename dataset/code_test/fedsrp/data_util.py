...
class HydroDataMeta:
    ...
    def load_core(self, path, unit_code, node_count):
        ...
        x_path = "train_unit"+str(unit_code)+"_"+str(node_count)+"basins_t30_x.txt"
        y_path = "train_unit"+str(unit_code)+"_"+str(node_count)+"basins_t30_y.txt"
    ...
    def load_core_test(self, path, unit_code, node_count):
        """Load hydro 01 from `path`"""
        x_path = "test_unit" + str(unit_code) + "_" + str(
            node_count) + "basins_t30_x.txt"
        y_path = "test_unit" + str(unit_code) + "_" + str(
